document.addEventListener('DOMContentLoaded', () => {
    ...
    if (sessionStorage.getItem('currentTheme') == 'fun') {
        loadFunTheme.textContent = 'Load Professional Theme';
        document.body.classList.toggle('fun-mode');
    } else {
        loadFunTheme.textContent = 'Load Fun Theme';
    ...
    settingsBtn.addEventListener('click', () => {
        ...
        settings.style.height = settingsExpanded ? '51px' : '352px';
    ...
    loadFunTheme.addEventListener('click', () => {
        ...
        overlay.style.backgroundColor = 'black';
        sessionStorage.setItem('currentTheme', document.body.classList.contains('fun-mode') ? 'professional' : 'fun');
    ...
    const navButtons = {
        ...
        aboutMeBtn: "aboutme.html",
        ContactmeBtn: "contactme.html",
        gameDevPrjBtn: "gamedev.html",
        programmingPrjBtn: "programming.html",
        WritePrjBtn: "writing.html",
        YTChannelBtn: "youtube.html"
    };
